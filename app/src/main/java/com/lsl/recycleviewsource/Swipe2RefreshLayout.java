 ...
 */
public class Swipe2RefreshLayout extends ViewGroup {
    private static final String LOG_TAG = Swipe2RefreshLayout.class.getSimpleName();
    ...
    private Swipe2ProgressBar mProgressBar; //the thing that shows progress is going
     ...
     * @param context
     */
    public Swipe2RefreshLayout(Context context) {
        this(context, null);
    }
     ...
     * @param attrs
     */
    public Swipe2RefreshLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
        ...
        mProgressBar = new Swipe2ProgressBar(this);
